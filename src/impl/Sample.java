...
public class Sample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        youTrack.login("megor", "Iocw290f,");

        //Get a list of all projects.
        List<Project> projectList = youTrack.projects.list();
        ...
        IssueId issueId = new IssueId("DOCASS-320233ee");

        Project project = youTrack.projects.item(issueId.projectId);

        //Output full name.
        System.out.println("Project " + project.getName() + " total issues: " + project.issues.query("*").size());
...
/*
        ...
        CommandResultSingleItem<IssueComment> newComment = issue.comments.add(IssueComment.createComment("Hey people, I am commenting via API!"));

        //And see if we did OK. This is our comment:
        System.out.println(newComment.getResult().toString());
*/
