...
final class AddIssueLink extends AddCommand<Issue, IssueLink> {
    ...
    HttpRequestBase createMethod() {
        ...
        result.setEntity(new UrlEncodedFormEntity(Collections.singletonList(new BasicNameValuePair("command", getItem().getTypeName() + getItem().getTarget())), Charsets.UTF_8));
        return result;
    }
}
